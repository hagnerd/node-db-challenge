  ...
  return knex('tasks').del()
    .then(function () {
      ...
      return knex('tasks').insert([
        ...
        {id: 2, description: "task-2", notes: "task-2-notes", project_id: 1, },
        ...
        {id: 5, description: "task-5", notes: "task-5-notes", project_id: 2, },
        ...
        {id: 8, description: "task-8", notes: "task-8-notes", project_id: 3, },
